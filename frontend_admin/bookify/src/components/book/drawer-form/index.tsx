            ...
            <Spin spinning={formLoading}>
                <Form {...formProps} layout="vertical">
                    ...
                    <Form.Item
                        ...
                        name="authors"
                        rules={[{ required: true, message: "Please add at least one author" }]}
                    >
                    ...
                    <Flex style={{ gap: 16 }}>
                        <Form.Item label={t("books.fields.condition")} name="condition">
                            ...
                            <Segmented options={[
                                ...
                                {
                                    label: t("books.fields.condition.options.likeNew", "LIKE NEW"),
                                    value: "LIKE NEW",
                                },
                                {
                                ...
                                {
                                    label: t("books.fields.condition.options.acceptable", "ACCEPTABLE"),
                                    value: "ACCEPTABLE",
                                }
                            ]}
                                       />
                    ...
                    <Form.Item
                        ...
                        name="categoryIds"
                        rules={[{ required: true, message: "Select one or more categories" }]}
                    >
                        <Select
                            {...categorySelectProps}
