...
export default function PersonalTab() {
    ...
    useEffect(() => {
        if (selectedCountry && selectedCountry !== user.address?.country) {
            addressForm.setValue("state", "")
            addressForm.setValue("city", "")
        }
    }, [selectedCountry, addressForm, user])

    useEffect(() => {
        if (selectedState && selectedState !== user.address?.state) {
            addressForm.setValue("city", "")
        }
    }, [selectedState, addressForm, user])
        ...
        <div className="relative space-y-10 pb-5">
            <div className="flex items-center space-x-6 p-6 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl">
                <div className="relative">
                    ...
                    />
                    <label className="absolute bottom-0 right-0 bg-[#1C387F] text-white p-2 rounded-full cursor-pointer hover:bg-[#153066] transition-all duration-200 shadow-lg">
                        <Camera size={14} />
                        <input
                            type="file"
                            accept="image/*"
                ...
                <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-red-700 mb-4">
                            Temporarily deactivate your account. You can reactivate it anytime by contacting Bookify Support.
                        </p>
                        <button
            ...
            {showSave && (
                <div className="fixed left-1/2 bottom-6 transform -translate-x-1/2 flex space-x-4">
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center space-x-2 bg-[#1C387F] text-white text-sm font-semibold py-3 px-8 rounded-full
              ...
              transition-all duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex items-center space-x-2 bg-[#F06548] text-white text-sm font-semibold py-3 px-8 rounded-full
              shadow-lg hover:shadow-xl hover:bg-[#D64534] transform hover:-translate-y-0.5
              transition-all duration-200 ease-in-out disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                    >
                        <span>Reset</span>
                    </button>
